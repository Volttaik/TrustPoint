...
export const NIGERIAN_BANKS: BankInfo[] = [
  ...
  { name: "First Bank",        color: "#00A0DC",  initials: "FB",  hasLogo: true  },
  ...
  { name: "Stanbic IBTC",      color: "#009BDE",  initials: "SI",  hasLogo: true  },
  ...
  { name: "PremiumTrust Bank", color: "#006B3F",  initials: "PT",  hasLogo: true  },
