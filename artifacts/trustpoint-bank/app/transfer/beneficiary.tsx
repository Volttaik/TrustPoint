  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={[styles.searchBar, { backgroundColor: colors.surface, borderColor: colors.border }]}>
        <TpIcon name="search" size={18} color={colors.mutedForeground} strokeWidth={1.8} />
        <TextInput
        ...
        {query.length > 0 && (
          <TouchableOpacity onPress={() => setQuery("")}>
            <TpIcon name="x" size={16} color={colors.mutedForeground} strokeWidth={2} />
          </TouchableOpacity>
        )}
      </View>
      ...
      >
        <View style={[styles.addIcon, { backgroundColor: colors.primary + "22" }]}>
          <TpIcon name="user-plus" size={18} color={colors.primary} strokeWidth={1.8} />
        </View>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.empty}>
            <TpIcon name="users" size={32} color={colors.mutedForeground} strokeWidth={1.5} />
...
const styles = StyleSheet.create({
  ...
  searchBar: { flexDirection: "row", alignItems: "center", gap: 10, marginHorizontal: 20, marginBottom: 12, paddingHorizontal: 14, height: 48, borderRadius: 24, borderWidth: 1 },
  searchInput: { flex: 1, fontSize: 15 },
  addNew: { flexDirection: "row", alignItems: "center", gap: 12, marginHorizontal: 20, marginBottom: 16, padding: 14, borderRadius: 14, borderWidth: 1.5, borderStyle: "dashed" },
